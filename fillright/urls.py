...
from .views import HomePageView, lead_form, success_page, custom_admin_login, custom_admin_panel, custom_admin_logout, admin_lead_detail, webhook

urlpatterns = [
    path('', HomePageView.as_view(), name='fillright_home'),  # Home page for fillright.silvara.uz
